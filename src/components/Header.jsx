		...
		<header className="header">
			...
			<div className="header__content">
				...
				<div className="header__content-cube">
					<div className="header__content-cube-nav">
						<div className="header__content-cube-nav-cube nav-btn">
							Cube
						</div>
						<div className="header__content-cube-nav-highlighted nav-btn">
							Highlighted
						</div>
						<div className="header__content-cube-nav-outcomes nav-btn">
							Outcomes
						</div>
					</div>
